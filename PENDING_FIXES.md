...
## 2. Footer h4 → h3 heading order (index.html + all sub-page templates)
...
## 3. Footer bottom opacity too low (contrast failure)
...
## 4. Logo link aria-label causes WCAG 2.5.3 label mismatch
...
## 8. em color on dark sections fails contrast when primary is a dark color
